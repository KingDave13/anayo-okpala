          ...
          >
              ...
              >
                ...
                <div className='md:mt-10 ss:mt-7 mt-5 text-center'>
                  <p className='text-white font-normal md:text-[23px]
                  ss:text-[22px] text-[15px]'>
                    <span className='text-secondary font-bold'>Email:
                    </span> Anasconigltd@yahoo.com
                  </p>

                  <p className='text-white font-normal md:text-[23px]
                  ss:text-[20px] text-[14px] md:mt-2 ss:mt-1 mt-1'>
                    <span className='text-secondary font-bold'>Phone:
                    </span> 08037002296, 08035895253, 08134353345.
                  </p>

                  <p className='text-white font-normal md:text-[23px]
                  ss:text-[20px] text-[14px] leading-[17px] md:mt-3
                  ss:mt-2 mt-1'>
                    <span className='text-secondary font-bold'>Head Office:
                    </span> No. 101 Ibrahim Taiwo Road by Sani Ungogo,
                    Kano State.
                  </p>

                  <p className='text-white font-normal md:text-[23px]
                  ss:text-[20px] text-[14px] leading-[17px] md:mt-5
                  ss:mt-4 mt-1'>
                    <span className='text-secondary font-bold'>Branch Office:
                    </span> No 9 Festing Road, Sabon Gari, Kano State.
                  </p>
                </div>
              </motion.div>
          </div>
